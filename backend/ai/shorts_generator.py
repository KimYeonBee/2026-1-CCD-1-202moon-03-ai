...

{
  ...
  "scenes": [
    {
      "scene_number": 1,
      "narration": "이 씬의 한국어 나레이션 (35~50자, 약 6~8초 분량)",
...
Visual: 화면에 보이는 것을 구체적으로 묘사하라. 추상적 설명 금지. 반드시 포함할 것:
  - 등장인물 수, 외모, 의상 (예: "A young Korean man in a white lab coat")
  - 구체적 동작 (예: "grabs a glowing cake slice from a table")
  - 배경/소품 (예: "in a neon-lit kitchen with oversized utensils on the wall")
  - ❌ 나쁜 예: "characters competing for resources" (누가? 어디서? 어떻게?)
  - ✅ 좋은 예: "Two men in suits wrestle over a golden fish on a tiny wooden boat"
